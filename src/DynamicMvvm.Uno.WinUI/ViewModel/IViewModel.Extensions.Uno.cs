...
namespace Chinook.DynamicMvvm
{
	...
	{
		/// <summary>
		/// Attaches a <see cref="IViewModel"/> to a <paramref name="frameworkElement"/> by setting the <see cref="IViewModel.Dispatcher"/> using the <see cref="DispatcherQueueDispatcher"/> implementation.
		/// </summary>
		...
		{
			viewModel.Dispatcher = new DispatcherQueueDispatcher(frameworkElement);
		}
	}
}
